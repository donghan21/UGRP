  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: Column(
          children: [
            ...
            SizedBox(height: 50.h, width: 200.w, child: Text('런지'),),
            Text(
              '런지\n',
            ),
            Text('1. 발을 어깨 너비로 유지한 상태의 중립 자세에서 엉덩이와 함께 한 발을 앞으로 내딛습니다.\n'
...
class SidePlankExplain extends StatelessWidget {
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(title: Text('Side Plank')),
        body: Column(
          children: [
            Container(
            ...
            Text('사이드플랭크\n'),
            Text('일반적인 플랭크 자세에서 몸의 한쪽을 개방시키면서 사이드 플랭크 자세로 변형'
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: Column(
          children: [
            ...
            Text('스쿼트\n'),
            Text('무산소 운동 중 하나로 데드리프트, 벤치 프레스와 더불어 웨이트 트레이닝의 3대 운동 중 하나'
